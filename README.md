...
Iris AI is a pocket-sized AI assistant powered by small language models (SLMs) that run directly on your phone. Designed for both iOS and Android, Iris AI lets you interact with various SLMs without the need for an internet connection. Your privacy is fully protected as all processing happens entirely on-device — your conversations, prompts, and data never leave your phone or get stored on external servers.
...
- **🌐 Localization Support (v1.8.16, Apr, 2025)**: Iris AI now supports multiple languages (At the moment Japanese and Chinese).
...
- **🎨 New Icon Alert (Nov 2024)**: Iris AI has a fresh new look! Huge thanks to **[Chun Te Lee](https://github.com/Reeray)** for the design! [Read more](https://github.com/a-ghorbani/Iris-ai/discussions/102).
- **🚀 Hugging Face Public Hub Integration (v1.5, Nov 2024)**: Iris AI now integrates with the Hugging Face model Hub! Browse, download, and run models directly from the Hugging Face Hub within the app. [Read more](https://github.com/a-ghorbani/Iris-ai/discussions/104)
...
Download Iris AI from the App Store:

[**Download on the App Store**](https://apps.apple.com/us/app/Iris-ai/id6502579498)

### Android

Get Iris AI on Google Play:

[**Get it on Google Play**](https://play.google.com/store/apps/details?id=com.Irisai)
...
2. Iris offers two different pal types:
...
4. Share your benchmark results and compare with other devices on the [Iris AI Phone Leaderboard](https://huggingface.co/spaces/a-ghorbani/ai-phone-leaderboard).
...
2. In Iris AI:
   ...
   <img src="assets/images and logos/Token_in_Iris.png" alt="Token Setup in Iris" width="66%">
...
1. **Fork and Clone the Repository**
   ...
   ```bash
   git clone https://github.com/a-ghorbani/Iris-ai
   cd Iris-ai
   ```
...
Iris AI is built using the amazing work from:
