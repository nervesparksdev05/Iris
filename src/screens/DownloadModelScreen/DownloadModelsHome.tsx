...
import {createStyles} from '../ModelsScreen/styles';
import {HFModelSearch} from '../ModelsScreen/HFModelSearch';
import {ModelAccordion} from '../ModelsScreen/ModelAccordion';
import {
  DownloadErrorDialog,
  ErrorSnackbar,
  ModelSettingsSheet,
...
import {DownloadModelScreen} from './DownloadModelScreen';
      ...
      <View style={ModelStyles.container}>
        <View style={ModelStyles.modal}>
          ...
          <FlatList
            ...
            contentContainerStyle={ModelStyles.scrollContainer}
            data={flatListModels}
          ...
          <Portal>
            <DownloadErrorDialog
              ...
              onDismiss={() => modelStore.clearDownloadError()}
